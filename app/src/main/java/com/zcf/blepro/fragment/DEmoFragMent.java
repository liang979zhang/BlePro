...
public class DEmoFragMent extends Fragment {
    ...
    @BindView(R.id.iv_youmen)
    ImageView ivYoumen;
    @BindView(R.id.ll_youmen)
    LinearLayout llYoumen;
    ...
    @OnClick({R.id.ll_dianhuo, R.id.ll_daishu, R.id.ll_jiashi, R.id.ll_youmen, R.id.iv_save, R.id.iv_kaiguan})
