...
//private static int innerR = (int) (outerR * 0.85f);//内部圆环的半径
    ...
    private int currentAngle ;//当前角度用来改变颜色
...
//            innerRectF = new RectF(-(width*0.85f), -(width*0.85f), (width*0.85f),(width*0.85f));
    ...
    private void drawArrow(Canvas canvas) {
        ...
        arrowPath.lineTo((float) (innerR * Math.cos(currentAngle * 3.14 / 180)) + 20, (float) (innerR * Math.sin(currentAngle * 3.14 / 180)) + 20);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        nowY = nowY - height / 2;
        //算出角度 重新绘画
        currentAngle = (int) (Math.atan2(nowY, nowX) * 180 / Math.PI) + 90;
